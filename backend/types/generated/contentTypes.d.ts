...
export interface ApiExtraServiceExtraService
  extends Struct.CollectionTypeSchema {
...
export interface ApiLoyaltyProgressLoyaltyProgress
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cycleStartedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['limpieza', 'interior', 'exterior', 'accesorios', 'otros']
    > &
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bookingSlotDuration: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 5;
        },
    ...
    businessHours: Schema.Attribute.Component<'shared.business-hour', true>;
    businessName: Schema.Attribute.String;
    closedDates: Schema.Attribute.Component<'shared.closed-date', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visitsForReward: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    plate: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::extra-service.extra-service': ApiExtraServiceExtraService;
      'api::loyalty-progress.loyalty-progress': ApiLoyaltyProgressLoyaltyProgress;
