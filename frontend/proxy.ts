...
const ADMIN_PROTECTED = ["/dashboard", "/escanear", "/walk-in", "/en-progreso", "/clientes", "/paquetes-admin", "/extras-admin", "/productos-admin", "/snacks-admin", "/promociones-admin", "/reservaciones", "/servicios"];
